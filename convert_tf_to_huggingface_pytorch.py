#the following code is a modified version of the one from
#https://github.com/salesforce/ctrl/blob/master/convert_tf_to_huggingface_pytorch.py 
#with some adaptation made by us for change the layers of the pretrained model
...
# get configuration
con = CTRLConfig(n_layer = args.num_layers)
#print(con.n_layer)

# create model
print("INFO :: Creating model with ", args.num_layers, " layers")
model = CTRLLMHeadModel(con)
#print(model.config.n_layer)
#print(model.transformer.h[args.num_layers-1])
...
print("INFO :: Start copying model parameters")
